...
export const styles: Record<string, React.CSSProperties | Record<string, unknown>> = {
    ...
    soundboardSoundBtn: {
        background: "linear-gradient(to bottom, var(--color-surface-elevated), var(--color-surface))",
        ...
        aspectRatio: "1",
        width: "100%",
        boxShadow: "inset 0 1px 0 rgba(255,255,255,0.06), 0 4px 0 var(--color-bg), 0 6px 10px rgba(0,0,0,0.45)",
